  ...
  return (
    ...
    >
      <div className="md:w-lg sm:w-sm dark:border-tertiary">
        ...
        <div className="flex flex-col space-y-6 mb-8 border border-gray-200 rounded-lg shadow-xs dark:border-gray-700 bg-white dark:bg-gray-800 p-6">
          {recommendations.map((recommendation) => (
            <figure
              key={`recommendation-${recommendation.name}`}
              className="flex flex-col items-center text-center bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 pb-6 last:border-b-0"
            >
